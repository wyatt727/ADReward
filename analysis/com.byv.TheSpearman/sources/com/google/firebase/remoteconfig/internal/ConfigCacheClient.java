...
public class ConfigCacheClient {
    ...
    private static final Executor DIRECT_EXECUTOR = AdIdManager$Api33Ext4Impl$$ExternalSyntheticLambda0.INSTANCE;
    ...
    public /* synthetic */ Void m507xddaae01c(ConfigContainer configContainer) throws Exception {
    ...
    public Task<ConfigContainer> put(final ConfigContainer configContainer, final boolean z) {
        return Tasks.call(this.executor, new Callable() { // from class: com.google.firebase.remoteconfig.internal.ConfigCacheClient$$ExternalSyntheticLambda1
            ...
            public final Object call() {
                return this.f$0.m507xddaae01c(configContainer);
            }
        }).onSuccessTask(this.executor, new SuccessContinuation() { // from class: com.google.firebase.remoteconfig.internal.ConfigCacheClient$$ExternalSyntheticLambda0
            @Override // com.google.android.gms.tasks.SuccessContinuation
            public final Task then(Object obj) {
                return this.f$0.m508x9820809d(z, configContainer, (Void) obj);
            }
        });
    }

    /* renamed from: lambda$put$1$com-google-firebase-remoteconfig-internal-ConfigCacheClient, reason: not valid java name */
    public /* synthetic */ Task m508x9820809d(boolean z, ConfigContainer configContainer, Void r3) throws Exception {
        if (z) {
