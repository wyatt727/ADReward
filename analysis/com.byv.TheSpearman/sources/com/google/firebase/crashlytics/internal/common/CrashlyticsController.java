...
class CrashlyticsController {
    ...
    static List<NativeSessionFile> getNativeSessionFiles(NativeSessionFileProvider nativeSessionFileProvider, String str, FileStore fileStore, byte[] bArr) {
        ...
        arrayList.add(new FileBackedNativeSessionFile("device_meta_file", t2.h.G, nativeSessionFileProvider.getDeviceFile()));
        arrayList.add(new FileBackedNativeSessionFile("os_meta_file", i5.x, nativeSessionFileProvider.getOsFile()));
