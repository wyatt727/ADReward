...
public final class zzb {
    ...
    private static final ImmutableList<String> zzc = ImmutableList.of("auto", MBridgeConstans.DYNAMIC_VIEW_WX_APP, "am");
    ...
    public static AnalyticsConnector.ConditionalUserProperty zza(Bundle bundle) {
        ...
        conditionalUserProperty.name = (String) Preconditions.checkNotNull((String) zzir.zza(bundle, "name", String.class, null));
    ...
    public static String zza(String str) {
        String strZza = zziu.zza(str);
        return strZza != null ? strZza : str;
    }

    public static String zzb(String str) {
        String strZzb = zziu.zzb(str);
