...
public final class SessionsSettings {
    ...
    @DebugMetadata(c = "com.google.firebase.sessions.settings.SessionsSettings", f = "SessionsSettings.kt", i = {0}, l = {138, Opcodes.F2I}, m = "updateSettings", n = {"this"}, s = {"L$0"})
    ...
    public final long m520getSessionRestartTimeoutUwyO8pc() {
        Duration durationMo518getSessionRestartTimeoutFghU774 = this.localOverrideSettings.mo518getSessionRestartTimeoutFghU774();
        if (durationMo518getSessionRestartTimeoutFghU774 != null) {
            long rawValue = durationMo518getSessionRestartTimeoutFghU774.getRawValue();
            if (m519isValidSessionRestartTimeoutLRDsOJo(rawValue)) {
                return rawValue;
            }
        }
        Duration durationMo518getSessionRestartTimeoutFghU7742 = this.remoteSettings.mo518getSessionRestartTimeoutFghU774();
        if (durationMo518getSessionRestartTimeoutFghU7742 != null) {
            long rawValue2 = durationMo518getSessionRestartTimeoutFghU7742.getRawValue();
            if (m519isValidSessionRestartTimeoutLRDsOJo(rawValue2)) {
                return rawValue2;
            }
        }
    ...
    private final boolean m519isValidSessionRestartTimeoutLRDsOJo(long sessionRestartTimeout) {
        return Duration.m2422isPositiveimpl(sessionRestartTimeout) && Duration.m2417isFiniteimpl(sessionRestartTimeout);
    }
    ...
    */
    public final java.lang.Object updateSettings(kotlin.coroutines.Continuation<? super kotlin.Unit> r6) throws java.lang.Throwable {
        /*
            r5 = this;
