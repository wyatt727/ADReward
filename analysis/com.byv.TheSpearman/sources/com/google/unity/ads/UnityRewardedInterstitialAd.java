...
public class UnityRewardedInterstitialAd {
    ...
    class AnonymousClass1 implements Runnable {
        ...
        public void run() {
            RewardedInterstitialAd.load(this.this$0.activity, this.val$adUnitId, this.val$request, new C01981());
        }
        ...
        class C01981 extends RewardedInterstitialAdLoadCallback {
            C01981() {
            }
