...
public class UnityRewardedAd {
    ...
    class AnonymousClass1 implements Runnable {
        ...
        public void run() {
            RewardedAd.load(this.this$0.activity, this.val$adUnitId, this.val$request, new C01921());
        }
        ...
        class C01921 extends RewardedAdLoadCallback {
            C01921() {
            }
