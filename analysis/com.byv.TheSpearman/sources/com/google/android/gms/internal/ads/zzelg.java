...
public final class zzelg implements zzegj {
    ...
    public final ListenableFuture zza(final zzffz zzffzVar, final zzffn zzffnVar) {
        ...
        ListenableFuture listenableFutureZzn = zzgee.zzn(zzgee.zzh(null), new zzgdl() { // from class: com.google.android.gms.internal.ads.zzekz
            @Override // com.google.android.gms.internal.ads.zzgdl
            public final ListenableFuture zza(Object obj) {
                return this.zza.zzc(zzffnVar, zzffzVar, zzdrmVar, obj);
            }
        }, this.zze);
        listenableFutureZzn.addListener(new Runnable() { // from class: com.google.android.gms.internal.ads.zzela
    ...
    final /* synthetic */ ListenableFuture zzc(final zzffn zzffnVar, zzffz zzffzVar, zzdrm zzdrmVar, Object obj) throws Exception {
        ...
        final zzdqn zzdqnVarZze = this.zzc.zze(new zzcul(zzffzVar, zzffnVar, null), new zzdqo(new zzelf(this.zza, this.zzb, this.zzd, this.zzf, zzffnVar, zzcbwVar, zzcgmVarZza, this.zzg, this.zzh, this.zzi), zzcgmVarZza));
        zzcbwVar.zzc(zzdqnVarZze);
        zzblq.zzb(zzcgmVarZza, zzdqnVarZze.zzg());
        zzdqnVarZze.zzc().zzo(new zzczk() { // from class: com.google.android.gms.internal.ads.zzelb
        ...
        zzdqnVarZze.zzl().zzi(zzcgmVarZza, true, this.zzh ? this.zzg : null);
        zzdqnVarZze.zzl();
        zzffs zzffsVar = zzffnVar.zzt;
        return zzgee.zzm(zzdrh.zzj(zzcgmVarZza, zzffsVar.zzb, zzffsVar.zza), new zzfwf() { // from class: com.google.android.gms.internal.ads.zzelc
