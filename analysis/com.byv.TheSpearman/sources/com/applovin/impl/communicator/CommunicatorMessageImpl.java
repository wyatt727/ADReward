...
public abstract class CommunicatorMessageImpl extends Intent {
    ...
    public CommunicatorMessageImpl(Bundle bundle, String str, AppLovinCommunicatorPublisher appLovinCommunicatorPublisher) {
        super(str);
        this.f339a = UUID.randomUUID().toString();
    ...
    public String toString() {
        return "AppLovinCommunicatorMessage{publisherId=" + getPublisherId() + ", topic=" + getTopic() + "', uniqueId='" + this.f339a + "', data=" + this.data + AbstractJsonLexerKt.END_OBJ;
    }
}
