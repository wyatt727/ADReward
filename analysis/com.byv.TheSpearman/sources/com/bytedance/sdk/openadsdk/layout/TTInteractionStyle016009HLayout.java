...
public class TTInteractionStyle016009HLayout extends TTInteractionStyleBaseFrameLayout {
    ...
    protected void EYQ(Context context) {
        ...
        int iMZx3 = tr.mZx(context, 15.0f);
        ...
        RelativeLayout.LayoutParams layoutParams5 = new RelativeLayout.LayoutParams(tr.mZx(context, 100.0f), tr.mZx(context, 30.0f));
        if (Build.VERSION.SDK_INT >= 17) {
        ...
        if (Build.VERSION.SDK_INT >= 17) {
            layoutParams5.setMarginEnd(iMZx);
        }
    ...
    protected PAGTextView Pm(Context context) {
        ...
        pAGTextViewPm.setTextSize(2, 15.0f);
    ...
    protected PAGTextView mZx(Context context) {
        ...
        pAGTextViewMZx.setMaxWidth(tr.mZx(context, 250.0f));
        pAGTextViewMZx.setTextColor(-1);
        pAGTextViewMZx.setTextSize(2, 17.0f);
