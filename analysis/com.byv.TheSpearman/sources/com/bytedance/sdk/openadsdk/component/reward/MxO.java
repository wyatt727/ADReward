...
public class MxO {
    ...
    public void EYQ() {
        ...
        try {
            boolean z = Build.VERSION.SDK_INT >= 19 && com.bytedance.sdk.openadsdk.core.QQ.Kbd("sp_reward_video");
            ...
            if (file.exists() && file.isDirectory() && (fileArrListFiles2 = file.listFiles(new FileFilter() { // from class: com.bytedance.sdk.openadsdk.component.reward.MxO.1
        ...
        try {
            ...
            if (cacheDir == null || !cacheDir.exists() || !cacheDir.isDirectory() || (fileArrListFiles = cacheDir.listFiles(new FileFilter() { // from class: com.bytedance.sdk.openadsdk.component.reward.MxO.2
                @Override // java.io.FileFilter
    ...
    public void EYQ(AdSlot adSlot, com.bytedance.sdk.openadsdk.core.model.EYQ eyq) {
        if (eyq == null || eyq.HX() || adSlot == null || !TextUtils.isEmpty(adSlot.getBidAdm())) {
            return;
        }
        synchronized (eyq) {
            if (!eyq.HX()) {
    ...
    public static MxO EYQ(Context context) {
        if (EYQ == null) {
    ...
    private MxO(Context context) {
        this.mZx = context == null ? hu.EYQ() : context.getApplicationContext();
        this.Td = new pi("sp_reward_video");
    }

    public String EYQ(String str, String str2, int i) {
        File fileEYQ;
        if (!TextUtils.isEmpty(str) && (fileEYQ = EYQ(str2, i)) != null && fileEYQ.exists() && fileEYQ.isFile() && fileEYQ.length() > 0) {
    ...
    public void EYQ(final boolean z, final UB ub, final long j, String str) {
        ...
        com.bytedance.sdk.openadsdk.tp.Td.EYQ(str2, false, new com.bytedance.sdk.openadsdk.tp.mZx() { // from class: com.bytedance.sdk.openadsdk.component.reward.MxO.3
    ...
    public void EYQ(final UB ub, final EYQ<Object> eyq) {
        ...
        if (ub == null || ub.mN() == null || TextUtils.isEmpty(ub.mN().MxO())) {
            ...
            eyqPm.EYQ(new com.bytedance.sdk.component.IPb.EYQ.EYQ() { // from class: com.bytedance.sdk.openadsdk.component.reward.MxO.4
                ...
                public void EYQ(com.bytedance.sdk.component.IPb.mZx.Td td, com.bytedance.sdk.component.IPb.mZx mzx) {
                    if (mzx.IPb() && mzx.Kbd() != null && mzx.Kbd().exists()) {
                        ...
                        MxO.this.EYQ(true, ub, mzx.EYQ(), mzx.mZx());
                        return;
                    }
                    EYQ eyq3 = eyq;
                    if (eyq3 != null) {
                    ...
                    MxO.this.EYQ(false, ub, mzx.EYQ(), mzx.mZx());
                }
                ...
                public void EYQ(com.bytedance.sdk.component.IPb.mZx.Td td, IOException iOException) {
                    ...
                    MxO.this.EYQ(false, ub, -2L, iOException.getMessage());
                }
            });
        }
    }
