...
public class tp {
    public static void EYQ(String str, int i, String str2, String str3, String str4) throws JSONException {
        try {
            ...
            if (ubEYQ != null) {
                ...
                if (ubEYQ.xh() != null) {
                    if (!TextUtils.isEmpty(str2)) {
                        ubEYQ.xh().EYQ(str2);
                        ubEYQ.xh().mZx("Test the downloaded app");
                    } else {
                        ubEYQ.xh().EYQ((String) null);
                        ubEYQ.xh().mZx("");
                    }
                    if (TextUtils.isEmpty(str2)) {
                        str2 = str4;
            ...
            arrayList.add(ubEYQ);
            eyq.EYQ(arrayList);
            nWX nwx = new nWX(hu.EYQ(), eyq);
            nwx.EYQ(true);
            nwx.EYQ().show(com.bytedance.sdk.openadsdk.core.nWX.EYQ().Kbd().mZx());
        } catch (Exception e) {
            com.bytedance.sdk.component.utils.pi.EYQ("PlayableVerityHelper", e.getMessage());
        }
    }
}
