...
public class VwS extends com.bytedance.sdk.openadsdk.core.mZx.mZx {
    public VwS(Context context, com.bytedance.sdk.openadsdk.core.model.UB ub, String str, int i) {
    ...
    protected com.bytedance.sdk.openadsdk.core.model.HX EYQ(float f, float f2, float f3, float f4, SparseArray<Td.EYQ> sparseArray, long j, long j2, View view, View view2, String str, float f5, int i, float f6, int i2, JSONObject jSONObject) {
        ...
        this.hYh = i6;
        return new HX.EYQ().IPb(fMZx).Kbd(fMZx2).Pm(fMZx3).Td(fMZx4).mZx(j3).EYQ(j4).mZx(iArrEYQ).EYQ(iArrEYQ2).Td(tr.Td(view)).Pm(iArrTd).Pm(this.rfB).Kbd(this.lEs).IPb(this.xt).mZx(com.bytedance.sdk.openadsdk.core.QQ.mZx().EYQ() ? i5 : 2).EYQ(sparseArray).EYQ(str).EYQ(i2).EYQ(jSONObject).EYQ();
    }
