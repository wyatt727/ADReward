...
public abstract class AdSessionStatePublisher {
    ...
    private com.iab.omid.library.ironsrc.weakreference.b f1564a;
    private AdEvents b;
    ...
    public AdSessionStatePublisher() {
        a();
        this.f1564a = new com.iab.omid.library.ironsrc.weakreference.b(null);
    }
    ...
    void a(WebView webView) {
        this.f1564a = new com.iab.omid.library.ironsrc.weakreference.b(webView);
    }
    ...
    protected void a(com.iab.omid.library.ironsrc.adsession.a aVar, AdSessionContext adSessionContext, JSONObject jSONObject) throws JSONException {
        ...
        c.a(jSONObject4, RemoteConfigConstants.RequestFieldKey.APP_ID, com.iab.omid.library.ironsrc.internal.f.b().a().getApplicationContext().getPackageName());
