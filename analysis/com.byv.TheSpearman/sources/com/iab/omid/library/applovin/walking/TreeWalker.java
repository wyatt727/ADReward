...
public class TreeWalker implements a.InterfaceC0208a {
    ...
    private List<TreeWalkerTimeLogger> f1475a = new ArrayList();
    ...
    public void addTimeLogger(TreeWalkerTimeLogger treeWalkerTimeLogger) {
        if (this.f1475a.contains(treeWalkerTimeLogger)) {
            return;
        }
        this.f1475a.add(treeWalkerTimeLogger);
    }
    ...
    public void removeTimeLogger(TreeWalkerTimeLogger treeWalkerTimeLogger) {
        if (this.f1475a.contains(treeWalkerTimeLogger)) {
            this.f1475a.remove(treeWalkerTimeLogger);
        }
    }

    private void a(long j2) {
        if (this.f1475a.size() > 0) {
            for (TreeWalkerTimeLogger treeWalkerTimeLogger : this.f1475a) {
    ...
    @Override // com.iab.omid.library.applovin.processor.a.InterfaceC0208a
    public void a(View view, com.iab.omid.library.applovin.processor.a aVar, JSONObject jSONObject, boolean z) throws JSONException {
    ...
    private boolean a(View view, JSONObject jSONObject) throws JSONException {
        a.C0210a c0210aC = this.f.c(view);
        if (c0210aC == null) {
            return false;
        }
        com.iab.omid.library.applovin.utils.c.a(jSONObject, c0210aC);
        return true;
    }
}
