...
public class b extends AdSessionStatePublisher {
    ...
    class RunnableC0230b implements Runnable {
        ...
        private final WebView f1672a;

        RunnableC0230b() {
            this.f1672a = b.this.g;
        }
    ...
    public void b() {
        super.b();
        new Handler().postDelayed(new RunnableC0230b(), Math.max(4000 - (this.h == null ? 4000L : TimeUnit.MILLISECONDS.convert(f.b() - this.h.longValue(), TimeUnit.NANOSECONDS)), 2000L));
        this.g = null;
    }
