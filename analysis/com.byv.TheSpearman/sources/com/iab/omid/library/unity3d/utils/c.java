...
public class c {
    ...
    private static WindowManager f1639a;
    ...
    */
    private static com.iab.omid.library.unity3d.utils.c.b a(org.json.JSONObject r13) {
        /*
            ...
            r3 = 17
            if (r0 < r3) goto L27
            android.view.WindowManager r13 = com.iab.omid.library.unity3d.utils.c.f1639a
            if (r13 == 0) goto L66
            android.graphics.Point r13 = new android.graphics.Point
            r13.<init>(r2, r2)
            android.view.WindowManager r0 = com.iab.omid.library.unity3d.utils.c.f1639a
        ...
        L66:
            r13 = r1
        L67:
            com.iab.omid.library.unity3d.utils.c$b r0 = new com.iab.omid.library.unity3d.utils.c$b
            r0.<init>(r1, r13)
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iab.omid.library.unity3d.utils.c.a(org.json.JSONObject):com.iab.omid.library.unity3d.utils.c$b");
    }
    ...
    public static void a(Context context) {
        if (context != null) {
            ...
            f1639a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, a.C0227a c0227a) throws JSONException {
        com.iab.omid.library.unity3d.internal.e eVarA = c0227a.a();
        JSONArray jSONArray = new JSONArray();
        Iterator<String> it = c0227a.b().iterator();
        while (it.hasNext()) {
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f1640a[outputDeviceStatus.ordinal()] == 1;
    }
    ...
    public static void b(JSONObject jSONObject) throws JSONException {
        ...
        try {
            jSONObject.put("width", bVarA.f1641a);
