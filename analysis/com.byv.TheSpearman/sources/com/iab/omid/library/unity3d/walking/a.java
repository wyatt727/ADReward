...
public class a {
    ...
    private final HashMap<View, String> f1645a = new HashMap<>();
    private final HashMap<View, C0227a> b = new HashMap<>();
    ...
    public static class C0227a {
        ...
        public C0227a(e eVar, String str) {
            this.f1646a = eVar;
            a(str);
        }
    ...
    private void a(e eVar, com.iab.omid.library.unity3d.adsession.a aVar) {
        ...
        C0227a c0227a = this.b.get(view);
        if (c0227a != null) {
            c0227a.a(aVar.getAdSessionId());
        } else {
            this.b.put(view, new C0227a(eVar, aVar.getAdSessionId()));
        }
    }
    ...
    public String d(View view) {
        ...
        String str = this.f1645a.get(view);
        if (str != null) {
            this.f1645a.remove(view);
        }
        return str;
    }
                ...
                if (aVar.f()) {
                    ...
                    if (viewC != null) {
                        ...
                        if (strA == null) {
                            ...
                            this.f1645a.put(viewC, adSessionId);
                            a(aVar);
