...
public class TreeWalker implements a.InterfaceC0225a {
    ...
    private List<TreeWalkerTimeLogger> f1643a = new ArrayList();
    ...
    private void a(long j2) {
        if (this.f1643a.size() > 0) {
            for (TreeWalkerTimeLogger treeWalkerTimeLogger : this.f1643a) {
    ...
    private boolean a(View view, JSONObject jSONObject) throws JSONException {
        a.C0227a c0227aC = this.f.c(view);
        if (c0227aC == null) {
            return false;
        }
    ...
    public void a(View view, com.iab.omid.library.unity3d.processor.a aVar, JSONObject jSONObject, boolean z) throws JSONException {
    ...
    public void addTimeLogger(TreeWalkerTimeLogger treeWalkerTimeLogger) {
        if (this.f1643a.contains(treeWalkerTimeLogger)) {
            return;
        }
        this.f1643a.add(treeWalkerTimeLogger);
    }
    ...
    public void removeTimeLogger(TreeWalkerTimeLogger treeWalkerTimeLogger) {
        if (this.f1643a.contains(treeWalkerTimeLogger)) {
            this.f1643a.remove(treeWalkerTimeLogger);
        }
    }
}
