...
public class b extends AdSessionStatePublisher {
    ...
    class RunnableC0226b implements Runnable {
        ...
        private final WebView f1637a;

        RunnableC0226b() {
            this.f1637a = b.this.g;
        }
    ...
    public void b() {
        super.b();
        new Handler().postDelayed(new RunnableC0226b(), Math.max(4000 - (this.h == null ? 4000L : TimeUnit.MILLISECONDS.convert(f.b() - this.h.longValue(), TimeUnit.NANOSECONDS)), 2000L));
        this.g = null;
    }
