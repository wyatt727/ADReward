...
public class TreeWalker implements a.InterfaceC0212a {
    ...
    private List<TreeWalkerTimeLogger> f1508a = new ArrayList();
    ...
    private void a(long j2) {
        if (this.f1508a.size() > 0) {
            for (TreeWalkerTimeLogger treeWalkerTimeLogger : this.f1508a) {
    ...
    private boolean a(View view, JSONObject jSONObject) throws JSONException {
        a.C0213a c0213aC = this.f.c(view);
        if (c0213aC == null) {
            return false;
        }
        com.iab.omid.library.bytedance2.utils.c.a(jSONObject, c0213aC);
        return true;
    }
    ...
    @Override // com.iab.omid.library.bytedance2.processor.a.InterfaceC0212a
    public void a(View view, com.iab.omid.library.bytedance2.processor.a aVar, JSONObject jSONObject, boolean z) throws JSONException {
    ...
    public void addTimeLogger(TreeWalkerTimeLogger treeWalkerTimeLogger) {
        if (this.f1508a.contains(treeWalkerTimeLogger)) {
            return;
        }
        this.f1508a.add(treeWalkerTimeLogger);
    }
    ...
    public void removeTimeLogger(TreeWalkerTimeLogger treeWalkerTimeLogger) {
        if (this.f1508a.contains(treeWalkerTimeLogger)) {
            this.f1508a.remove(treeWalkerTimeLogger);
        }
    }
}
