...
public class c {
    ...
    private static WindowManager f1605a;
    ...
    */
    private static com.iab.omid.library.mmadbridge.utils.c.b a(org.json.JSONObject r13) {
        /*
            ...
            r3 = 17
            if (r0 < r3) goto L27
            android.view.WindowManager r13 = com.iab.omid.library.mmadbridge.utils.c.f1605a
            if (r13 == 0) goto L66
            android.graphics.Point r13 = new android.graphics.Point
            r13.<init>(r2, r2)
            android.view.WindowManager r0 = com.iab.omid.library.mmadbridge.utils.c.f1605a
    ...
    public static void a(Context context) {
        if (context != null) {
            ...
            f1605a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, a.C0223a c0223a) throws JSONException {
        com.iab.omid.library.mmadbridge.internal.e eVarA = c0223a.a();
        JSONArray jSONArray = new JSONArray();
        Iterator<String> it = c0223a.b().iterator();
        while (it.hasNext()) {
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f1606a[outputDeviceStatus.ordinal()] == 1;
    }
    ...
    public static void b(JSONObject jSONObject) throws JSONException {
        ...
        try {
            jSONObject.put("width", bVarA.f1607a);
