...
public final /* data */ class AuctionRequestInstanceInfo {
    ...
    public AuctionRequestInstanceInfo(String name, boolean z) {
    ...
    public static /* synthetic */ AuctionRequestInstanceInfo a(AuctionRequestInstanceInfo auctionRequestInstanceInfo, String str, boolean z, int i, Object obj) {
        if ((i & 1) != 0) {
            str = auctionRequestInstanceInfo.name;
        }
        if ((i & 2) != 0) {
            z = auctionRequestInstanceInfo.bidder;
        }
        return auctionRequestInstanceInfo.a(str, z);
    }

    public final AuctionRequestInstanceInfo a(String name, boolean bidder) {
        Intrinsics.checkNotNullParameter(name, "name");
        return new AuctionRequestInstanceInfo(name, bidder);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof AuctionRequestInstanceInfo)) {
            return false;
        }
        AuctionRequestInstanceInfo auctionRequestInstanceInfo = (AuctionRequestInstanceInfo) other;
        return Intrinsics.areEqual(this.name, auctionRequestInstanceInfo.name) && this.bidder == auctionRequestInstanceInfo.bidder;
    }
