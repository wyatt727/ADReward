...
public final class ConfigPayload$ReportIncentivizedSettings$$serializer implements GeneratedSerializer<ConfigPayload.ReportIncentivizedSettings> {
    ...
    static {
        ...
        pluginGeneratedSerialDescriptor.addElement(m4.r, false);
    ...
    public ConfigPayload.ReportIncentivizedSettings deserialize(Decoder decoder) {
        ...
        return new ConfigPayload.ReportIncentivizedSettings(i, zDecodeBooleanElement, null);
    }

    @Override // kotlinx.serialization.SerializationStrategy
    public void serialize(Encoder encoder, ConfigPayload.ReportIncentivizedSettings value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(value, "value");
        SerialDescriptor descriptor2 = getDescriptor();
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(descriptor2);
        ConfigPayload.ReportIncentivizedSettings.write$Self(value, compositeEncoderBeginStructure, descriptor2);
