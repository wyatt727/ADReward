...
public final class DeviceNode$DeviceExt$$serializer implements GeneratedSerializer<DeviceNode.DeviceExt> {
    ...
    public DeviceNode.DeviceExt deserialize(Decoder decoder) {
        ...
        if (compositeDecoderBeginStructure.decodeSequentially()) {
            objDecodeSerializableElement = compositeDecoderBeginStructure.decodeSerializableElement(descriptor2, 0, DeviceNode$VungleExt$$serializer.INSTANCE, null);
        } else {
            ...
            while (i != 0) {
                ...
                if (iDecodeElementIndex == -1) {
                    ...
                    objDecodeSerializableElement = compositeDecoderBeginStructure.decodeSerializableElement(descriptor2, 0, DeviceNode$VungleExt$$serializer.INSTANCE, objDecodeSerializableElement);
                    i2 |= 1;
                }
            }
            i = i2;
        ...
        return new DeviceNode.DeviceExt(i, (DeviceNode.VungleExt) objDecodeSerializableElement, null);
    }
    ...
    public void serialize(Encoder encoder, DeviceNode.DeviceExt value) {
        ...
        DeviceNode.DeviceExt.write$Self(value, compositeEncoderBeginStructure, descriptor2);
