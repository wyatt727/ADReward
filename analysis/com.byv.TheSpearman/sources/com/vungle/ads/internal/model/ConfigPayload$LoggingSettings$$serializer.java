...
public final class ConfigPayload$LoggingSettings$$serializer implements GeneratedSerializer<ConfigPayload.LoggingSettings> {
    ...
    public ConfigPayload.LoggingSettings deserialize(Decoder decoder) {
        ...
        return new ConfigPayload.LoggingSettings(i, zDecodeBooleanElement, (SerializationConstructorMarker) null);
    }

    @Override // kotlinx.serialization.SerializationStrategy
    public void serialize(Encoder encoder, ConfigPayload.LoggingSettings value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(value, "value");
        SerialDescriptor descriptor2 = getDescriptor();
        CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(descriptor2);
        ConfigPayload.LoggingSettings.write$Self(value, compositeEncoderBeginStructure, descriptor2);
