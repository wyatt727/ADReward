...
public class MBListView extends ListView implements InterBase {
    ...
    private Map<String, String> f2573a;
    ...
    public MBListView(Context context, AttributeSet attributeSet) {
        ...
        this.c = "";
        try {
            this.f2573a = c.a(context, attributeSet);
            a.a(this, attributeSet);
            setLayoutParams(generateLayoutParams(attributeSet));
            c.a(this.f2573a, this);
        } catch (Exception e) {
            ad.b("MBListView", e.getMessage());
        }
    }
    ...
    public AbsListView.LayoutParams generateLayoutParams(AttributeSet attributeSet) {
        ...
        for (int i = 0; i < attributeCount; i++) {
            ...
            if (cVar != null) {
                int i2 = AnonymousClass1.f2574a[cVar.ordinal()];
                if (i2 == 1) {
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                f2574a[com.mbridge.msdk.dycreator.a.c.layout_height.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f2574a[com.mbridge.msdk.dycreator.a.c.fadingEdge.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f2574a[com.mbridge.msdk.dycreator.a.c.visibility.ordinal()] = 4;
    ...
    public String getBindDataDes() {
        Map<String, String> map = this.f2573a;
        return (map == null || !map.containsKey("mbridgeData")) ? "" : this.f2573a.get("mbridgeData");
    }

    @Override // com.mbridge.msdk.dycreator.baseview.inter.InterBase
    public String getActionDes() {
        Map<String, String> map = this.f2573a;
        return (map == null || !map.containsKey("mbridgeAction")) ? "" : this.f2573a.get("mbridgeAction");
    }

    @Override // com.mbridge.msdk.dycreator.baseview.inter.InterBase
    public String getStrategyDes() {
        Map<String, String> map = this.f2573a;
        return (map == null || !map.containsKey("mbridgeStrategy")) ? "" : this.f2573a.get("mbridgeStrategy");
    }

    @Override // com.mbridge.msdk.dycreator.baseview.inter.InterBase
    public String getEffectDes() {
        Map<String, String> map = this.f2573a;
        return (map == null || !map.containsKey("mbridgeEffect")) ? "" : this.f2573a.get("mbridgeEffect");
    }

    @Override // com.mbridge.msdk.dycreator.baseview.inter.InterBase
    public String getReportDes() {
        Map<String, String> map = this.f2573a;
        return (map == null || !map.containsKey("mbridgeReport")) ? "" : this.f2573a.get("mbridgeReport");
    }
