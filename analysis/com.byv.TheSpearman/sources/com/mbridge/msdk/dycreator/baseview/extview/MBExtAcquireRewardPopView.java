...
public class MBExtAcquireRewardPopView extends MBAcquireRewardPopView implements InterBase {
    ...
    private Map<String, String> f2611a;
    ...
    public MBExtAcquireRewardPopView(Context context, AttributeSet attributeSet) {
        super(context);
        try {
            this.f2611a = c.a(context, attributeSet);
            setAttributeSet(attributeSet);
            setLayoutParams(generateLayoutParams(attributeSet));
            c.a(this.f2611a, this);
        } catch (Exception e) {
            ad.b("MBExtAcquireRewardPopView", e.getMessage());
        }
    }
    ...
    public void setAttributeSet(AttributeSet attributeSet) throws NumberFormatException {
        ...
        for (int i = 0; i < attributeCount; i++) {
            ...
            if (cVar != null) {
                int i2 = AnonymousClass1.f2612a[cVar.ordinal()];
                if (i2 == 1) {
    ...
    public String getBindDataDes() {
        ...
        return (map == null || !map.containsKey("mbridgeData")) ? "" : this.f2611a.get("mbridgeData");
    }

    @Override // com.mbridge.msdk.dycreator.baseview.inter.InterBase
    public String getActionDes() {
        Map<String, String> map = this.f2611a;
        return (map == null || !map.containsKey("mbridgeAction")) ? "" : this.f2611a.get("mbridgeAction");
    }

    @Override // com.mbridge.msdk.dycreator.baseview.inter.InterBase
    public String getStrategyDes() {
        Map<String, String> map = this.f2611a;
        return (map == null || !map.containsKey("mbridgeStrategy")) ? "" : this.f2611a.get("mbridgeStrategy");
    }

    @Override // com.mbridge.msdk.dycreator.baseview.inter.InterBase
    public String getEffectDes() {
        Map<String, String> map = this.f2611a;
        return (map == null || !map.containsKey("mbridgeEffect")) ? "" : this.f2611a.get("mbridgeEffect");
    }

    @Override // com.mbridge.msdk.dycreator.baseview.inter.InterBase
    public String getReportDes() {
        Map<String, String> map = this.f2611a;
        return (map == null || !map.containsKey("mbridgeReport")) ? "" : this.f2611a.get("mbridgeReport");
    }
}
