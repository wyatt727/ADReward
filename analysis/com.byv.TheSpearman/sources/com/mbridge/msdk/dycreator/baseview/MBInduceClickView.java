...
public class MBInduceClickView extends FrameLayout implements InterBase, InterEffect {
    ...
    private Map<String, String> f2569a;
    ...
    public MBInduceClickView(Context context, AttributeSet attributeSet) {
        ...
        if (context != null && attributeSet != null) {
            try {
                this.f2569a = c.a(context, attributeSet);
            } catch (Exception e) {
                ad.b("MBInduceClickView", e.getMessage());
                return;
            }
        }
        a.a(this, attributeSet);
        setLayoutParams(generateLayoutParams(attributeSet));
        c.a(this.f2569a, this);
    }
    ...
    public FrameLayout.LayoutParams generateLayoutParams(AttributeSet attributeSet) throws NumberFormatException {
        ...
        for (int i = 0; i < attributeCount; i++) {
            ...
            if (cVar != null) {
                int i2 = AnonymousClass1.f2570a[cVar.ordinal()];
                if (i2 == 1) {
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                f2570a[com.mbridge.msdk.dycreator.a.c.layout_height.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f2570a[com.mbridge.msdk.dycreator.a.c.layout_gravity.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f2570a[com.mbridge.msdk.dycreator.a.c.layout_marginLeft.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f2570a[com.mbridge.msdk.dycreator.a.c.layout_margin.ordinal()] = 5;
    ...
    public String getBindDataDes() {
        Map<String, String> map = this.f2569a;
        return (map == null || !map.containsKey("mbridgeData")) ? "" : this.f2569a.get("mbridgeData");
    }

    @Override // com.mbridge.msdk.dycreator.baseview.inter.InterBase
    public String getActionDes() {
        Map<String, String> map = this.f2569a;
        return (map == null || !map.containsKey("mbridgeAction")) ? "" : this.f2569a.get("mbridgeAction");
    }

    @Override // com.mbridge.msdk.dycreator.baseview.inter.InterBase
    public String getStrategyDes() {
        Map<String, String> map = this.f2569a;
        return (map == null || !map.containsKey("mbridgeStrategy")) ? "" : this.f2569a.get("mbridgeStrategy");
    }

    @Override // com.mbridge.msdk.dycreator.baseview.inter.InterBase
    public String getEffectDes() {
        Map<String, String> map = this.f2569a;
        return (map == null || !map.containsKey("mbridgeEffect")) ? "" : this.f2569a.get("mbridgeEffect");
    }

    @Override // com.mbridge.msdk.dycreator.baseview.inter.InterBase
    public String getReportDes() {
        Map<String, String> map = this.f2569a;
        return (map == null || !map.containsKey("mbridgeReport")) ? "" : this.f2569a.get("mbridgeReport");
    }
