...
public final class Response implements Closeable {
    ...
    public ResponseBody peekBody(long j) throws IOException {
        ...
        Buffer bufferM633clone = bufferedSourceSource.buffer().m633clone();
        if (bufferM633clone.size() > j) {
            Buffer buffer = new Buffer();
            buffer.write(bufferM633clone, j);
            bufferM633clone.clear();
            bufferM633clone = buffer;
        }
        return ResponseBody.create(this.body.contentType(), bufferM633clone.size(), bufferM633clone);
    }
