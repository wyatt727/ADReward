...
public final class RealConnection extends Http2Connection.Listener implements Connection {
    ...
    */
    ...
    private Request createTunnelRequest() throws IOException {
        Request requestBuild = new Request.Builder().url(this.route.address().url()).method("CONNECT", null).header(com.google.common.net.HttpHeaders.HOST, Util.hostHeader(this.route.address().url(), true)).header("Proxy-Connection", com.google.common.net.HttpHeaders.KEEP_ALIVE).header("User-Agent", Version.userAgent()).build();
