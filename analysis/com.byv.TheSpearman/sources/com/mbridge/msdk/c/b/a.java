...
public class a {
    ...
    public final String b() {
        try {
            ...
            if (TextUtils.isEmpty(this.c)) {
                g gVarB = h.a().b(c.m().k());
                if (gVarB != null && !TextUtils.isEmpty(gVarB.T())) {
                    a(c.m().c(), gVarB.T());
                }
                return f2496a;
            }
    ...
    private String c() {
        try {
            File file = new File(e.a(com.mbridge.msdk.foundation.same.b.c.MBRIDGE_OTHER), "mraid_js.txt");
            return (file.exists() && file.canRead()) ? ab.b(file) : "";
        } catch (Exception e) {
            ad.a("MraidJSController", e.getMessage());
            return "";
        }
    }
    ...
    public final void a(Context context, final String str) {
        ...
        String strA = com.mbridge.msdk.foundation.a.a.a.a().a("MraidJSController");
        if (TextUtils.isEmpty(strA) || !strA.equals(str)) {
            try {
                ...
                ad.b("MraidJSController", e.getMessage());
            }
        }
    }
