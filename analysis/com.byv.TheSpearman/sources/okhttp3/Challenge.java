...
public final class Challenge {
    ...
    public final Map<String, String> m2696deprecated_authParams() {
        return this.authParams;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "realm", imports = {}))
    /* renamed from: -deprecated_realm, reason: not valid java name */
    public final String m2698deprecated_realm() {
        return realm();
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = m4.L, imports = {}))
    /* renamed from: -deprecated_charset, reason: not valid java name */
    public final Charset m2697deprecated_charset() {
        return charset();
    }
