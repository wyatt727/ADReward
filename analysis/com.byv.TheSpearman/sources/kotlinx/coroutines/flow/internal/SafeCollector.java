...
public final class SafeCollector<T> extends ContinuationImpl implements FlowCollector<T>, CoroutineStackFrame {
    ...
    public Object invokeSuspend(Object result) {
        Throwable thM1065exceptionOrNullimpl = Result.m1065exceptionOrNullimpl(result);
        if (thM1065exceptionOrNullimpl != null) {
            this.lastEmissionContext = new DownstreamExceptionContext(thM1065exceptionOrNullimpl, getContext());
        }
        Continuation<? super Unit> continuation = this.completion;
