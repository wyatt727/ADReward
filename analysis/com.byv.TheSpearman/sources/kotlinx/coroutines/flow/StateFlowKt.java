...
public final class StateFlowKt {
    ...
    public static final <T> T updateAndGet(MutableStateFlow<T> mutableStateFlow, Function1<? super T, ? extends T> function1) {
        ...
        T tInvoke;
        do {
            universalRequestStoreKt = (Object) mutableStateFlow.getValue();
            tInvoke = function1.invoke(universalRequestStoreKt);
        } while (!mutableStateFlow.compareAndSet(universalRequestStoreKt, tInvoke));
        return tInvoke;
    }
    ...
    public static final <T> void update(MutableStateFlow<T> mutableStateFlow, Function1<? super T, ? extends T> function1) {
        ...
        do {
            universalRequestStoreKt = (Object) mutableStateFlow.getValue();
        } while (!mutableStateFlow.compareAndSet(universalRequestStoreKt, function1.invoke(universalRequestStoreKt)));
    }
