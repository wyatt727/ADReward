...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM1062constructorimpl = Result.m1062constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM1062constructorimpl = Result.m1062constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m1068isFailureimpl(objM1062constructorimpl) ? null : objM1062constructorimpl);
