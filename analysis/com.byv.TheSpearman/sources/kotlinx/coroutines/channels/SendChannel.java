...
public interface SendChannel<E> {
    ...
    Object mo2566trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            ...
            if (ChannelResult.m2586isSuccessimpl(objMo2566trySendJP2dKIU)) {
                return true;
            }
            Throwable thM2580exceptionOrNullimpl = ChannelResult.m2580exceptionOrNullimpl(objMo2566trySendJP2dKIU);
