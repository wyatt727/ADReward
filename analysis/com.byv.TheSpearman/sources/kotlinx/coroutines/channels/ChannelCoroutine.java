...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public Object mo2570receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        Object obj = this._channel.mo2570receiveCatchingJP2dKIU(continuation);
    ...
    public Object mo2571tryReceivePtdJZtk() {
        return this._channel.mo2571tryReceivePtdJZtk();
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* renamed from: trySend-JP2dKIU */
    public Object mo2566trySendJP2dKIU(E element) {
        return this._channel.mo2566trySendJP2dKIU(element);
    }
