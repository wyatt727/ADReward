...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) throws Throwable {
        ...
        Object objM2594trySendImplMj0NB7M = conflatedBufferedChannel.m2594trySendImplMj0NB7M(e, true);
        if (objM2594trySendImplMj0NB7M instanceof ChannelResult.Closed) {
            ChannelResult.m2580exceptionOrNullimpl(objM2594trySendImplMj0NB7M);
    ...
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Boolean> continuation) {
        Object objM2594trySendImplMj0NB7M = conflatedBufferedChannel.m2594trySendImplMj0NB7M(e, true);
        if (!(objM2594trySendImplMj0NB7M instanceof ChannelResult.Failed)) {
    ...
    public Object mo2566trySendJP2dKIU(E element) {
        return m2594trySendImplMj0NB7M(element, false);
    }

    /* renamed from: trySendImpl-Mj0NB7M, reason: not valid java name */
    private final Object m2594trySendImplMj0NB7M(E element, boolean isSendOp) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m2592trySendDropLatestMj0NB7M(element, isSendOp) : m2593trySendDropOldestJP2dKIU(element);
    }

    /* renamed from: trySendDropLatest-Mj0NB7M, reason: not valid java name */
    private final Object m2592trySendDropLatestMj0NB7M(E element, boolean isSendOp) {
        Function1<E, Unit> function1;
        UndeliveredElementException undeliveredElementExceptionCallUndeliveredElementCatchingException$default;
        Object objMo2566trySendJP2dKIU = super.mo2566trySendJP2dKIU(element);
        if (ChannelResult.m2586isSuccessimpl(objMo2566trySendJP2dKIU) || ChannelResult.m2584isClosedimpl(objMo2566trySendJP2dKIU)) {
            return objMo2566trySendJP2dKIU;
        }
    ...
    private final Object m2593trySendDropOldestJP2dKIU(E element) {
        ...
        while (true) {
            ...
            if (channelSegment2.id != j2) {
                ...
                if (channelSegmentFindSegmentSend != null) {
                    ...
                    return ChannelResult.INSTANCE.m2589closedJP2dKIU(getSendException());
                }
            } else {
    ...
    protected void registerSelectForSend(SelectInstance<?> select, Object element) {
        Object objMo2566trySendJP2dKIU = mo2566trySendJP2dKIU(element);
        if (!(objMo2566trySendJP2dKIU instanceof ChannelResult.Failed)) {
            select.selectInRegistrationPhase(Unit.INSTANCE);
        } else {
            if (!(objMo2566trySendJP2dKIU instanceof ChannelResult.Closed)) {
                throw new IllegalStateException("unreachable".toString());
            }
            ChannelResult.m2580exceptionOrNullimpl(objMo2566trySendJP2dKIU);
