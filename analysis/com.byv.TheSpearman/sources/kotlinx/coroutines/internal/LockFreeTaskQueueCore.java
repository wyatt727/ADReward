    ...
    */
    ...
    public final <R> List<R> map(Function1<? super E, ? extends R> transform) {
        ...
        while (true) {
            int i3 = this.mask;
            if ((i & i3) != (i2 & i3)) {
                ByteStringStoreOuterClass.ByteStringStore.Builder builder = (Object) this.array.get(i3 & i);
                if (builder != null && !(builder instanceof Placeholder)) {
                    arrayList.add(transform.invoke(builder));
                }
                i++;
            } else {
                return arrayList;
