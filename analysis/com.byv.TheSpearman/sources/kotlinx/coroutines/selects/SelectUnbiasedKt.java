...
public final class SelectUnbiasedKt {
    ...
    private static final <R> Object selectUnbiased$$forInline(Function1<? super SelectBuilder<? super R>, Unit> function1, Continuation<? super R> continuation) {
        ...
        UnbiasedSelectImplementation unbiasedSelectImplementation = new UnbiasedSelectImplementation(continuation2.get$context());
        function1.invoke(unbiasedSelectImplementation);
        InlineMarker.mark(3);
        InlineMarker.mark(0);
        Object objDoSelect = unbiasedSelectImplementation.doSelect(null);
        InlineMarker.mark(1);
        return objDoSelect;
    }
}
