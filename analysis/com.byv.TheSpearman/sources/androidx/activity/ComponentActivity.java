...
public class ComponentActivity extends androidx.core.app.ComponentActivity implements ContextAware, LifecycleOwner, ViewModelStoreOwner, HasDefaultViewModelProviderFactory, SavedStateRegistryOwner, OnBackPressedDispatcherOwner, ActivityResultRegistryOwner, ActivityResultCaller, OnConfigurationChangedProvider, OnTrimMemoryProvider, OnNewIntentProvider, OnMultiWindowModeChangedProvider, OnPictureInPictureModeChangedProvider, MenuHost, FullyDrawnReporterOwner {
    ...
    public /* synthetic */ Unit m2lambda$new$0$androidxactivityComponentActivity() {
        reportFullyDrawn();
        return null;
    }
    ...
    public ComponentActivity() {
        ...
        this.mFullyDrawnReporter = new FullyDrawnReporter(reportFullyDrawnExecutorCreateFullyDrawnExecutor, new Function0() { // from class: androidx.activity.ComponentActivity$$ExternalSyntheticLambda3
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return this.f$0.m2lambda$new$0$androidxactivityComponentActivity();
            }
        });
        ...
        getSavedStateRegistry().registerSavedStateProvider(ACTIVITY_RESULT_TAG, new SavedStateRegistry.SavedStateProvider() { // from class: androidx.activity.ComponentActivity$$ExternalSyntheticLambda1
            ...
            public final Bundle saveState() {
                return this.f$0.m3lambda$new$1$androidxactivityComponentActivity();
            }
        });
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: androidx.activity.ComponentActivity$$ExternalSyntheticLambda0
            ...
            public final void onContextAvailable(Context context) {
                this.f$0.m4lambda$new$2$androidxactivityComponentActivity(context);
            }
        });
    }

    /* renamed from: lambda$new$1$androidx-activity-ComponentActivity, reason: not valid java name */
    public /* synthetic */ Bundle m3lambda$new$1$androidxactivityComponentActivity() {
    ...
    public /* synthetic */ void m4lambda$new$2$androidxactivityComponentActivity(Context context) {
    ...
    class ReportFullyDrawnExecutorApi16Impl implements ReportFullyDrawnExecutor, ViewTreeObserver.OnDrawListener, Runnable {
        ...
        public /* synthetic */ void m5x96b76666() {
