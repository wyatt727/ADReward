...
public class TrustedWebActivityIntentBuilder {
    ...
    public TrustedWebActivityIntent build(CustomTabsSession customTabsSession) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
