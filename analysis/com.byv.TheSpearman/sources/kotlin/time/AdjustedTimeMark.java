...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark mo2379minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m2525minusLRDsOJo(this, j);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: elapsedNow-UwyO8pc */
    public long mo2378elapsedNowUwyO8pc() {
        return Duration.m2423minusLRDsOJo(this.mark.mo2378elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo2381plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m2424plusLRDsOJo(this.adjustment, duration), null);
    }
}
