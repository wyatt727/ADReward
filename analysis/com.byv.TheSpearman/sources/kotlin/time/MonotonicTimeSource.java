...
public final class MonotonicTimeSource implements TimeSource.WithComparableMarks {
    ...
    public /* bridge */ /* synthetic */ ComparableTimeMark markNow() {
        return TimeSource.Monotonic.ValueTimeMark.m2528boximpl(m2522markNowz9LOYto());
    }
    ...
    public long m2522markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m2531constructorimpl(read());
    }

    /* renamed from: elapsedFrom-6eNON_k, reason: not valid java name */
    public final long m2521elapsedFrom6eNON_k(long timeMark) {
    ...
    public final long m2520differenceBetweenfRLX17w(long one, long another) {
        return LongSaturatedMathKt.saturatingOriginsDiff(one, another, DurationUnit.NANOSECONDS);
    }

    /* renamed from: adjustReading-6QKq23U, reason: not valid java name */
    public final long m2519adjustReading6QKq23U(long timeMark, long duration) {
        return TimeSource.Monotonic.ValueTimeMark.m2531constructorimpl(LongSaturatedMathKt.m2517saturatingAddNuflL3o(timeMark, DurationUnit.NANOSECONDS, duration));
    }
}
