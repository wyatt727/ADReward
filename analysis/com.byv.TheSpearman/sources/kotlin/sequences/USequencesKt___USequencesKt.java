...
class USequencesKt___USequencesKt {
    public static final int sumOfUInt(Sequence<UInt> sequence) {
        ...
        int iM1157constructorimpl = 0;
        while (it.hasNext()) {
            iM1157constructorimpl = UInt.m1157constructorimpl(iM1157constructorimpl + it.next().getData());
        }
    ...
    public static final long sumOfULong(Sequence<ULong> sequence) {
        ...
        long jM1236constructorimpl = 0;
        while (it.hasNext()) {
            jM1236constructorimpl = ULong.m1236constructorimpl(jM1236constructorimpl + it.next().getData());
        }
    ...
    public static final int sumOfUByte(Sequence<UByte> sequence) {
        ...
        int iM1157constructorimpl = 0;
        while (it.hasNext()) {
            iM1157constructorimpl = UInt.m1157constructorimpl(iM1157constructorimpl + UInt.m1157constructorimpl(it.next().getData() & 255));
        }
        return iM1157constructorimpl;
    }
    ...
    public static final int sumOfUShort(Sequence<UShort> sequence) {
        ...
        int iM1157constructorimpl = 0;
        while (it.hasNext()) {
            iM1157constructorimpl = UInt.m1157constructorimpl(iM1157constructorimpl + UInt.m1157constructorimpl(it.next().getData() & UShort.MAX_VALUE));
        }
        return iM1157constructorimpl;
    }
}
