...
import { Plugin, PluginDescriptor, pipelineHooks, ScanContext } from '../hooks.js';
...
export default class CsvReporterPlugin implements Plugin {
   ...
   */
  private async generateCsvReport(context: ScanContext, components: ComponentMap): Promise<void> {
    try {
