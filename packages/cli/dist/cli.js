...
import { logger, requireDevice, acquire, decompile, scan, ensureFridaServer, generateFrida, loadPlugins, registerPluginCommands, watchFridaScript, diffComponentFiles } from '@adreward/core';
 ...
 */
function writeCrashReport(type, error, logBuffer) {
    try {
        ...
        // Write to file
        fs.writeFileSync(crashFile, JSON.stringify(reportData, null, 2));
